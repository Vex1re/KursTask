...
public class VoucherDAO {
    public List<Voucher> getAll() throws SQLException {
        ...
        String query = "SELECT v.id_tour, v.duration, v.price, h.id_hotel, h.name as hotel_name, h.class as hotel_class, c.id_country, c.name as country_name, c.climate " +
                       "FROM Vouchers v " +
        ...
        try (Connection conn = DatabaseConnection.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                vouchers.add(new Voucher(rs.getInt("id_tour"), rs.getInt("duration"), hotel, rs.getBigDecimal("price")));
            }
        }
        return vouchers;
    }
